...
public class AddUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EnderecoBairroUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EnderecoBairroUserActionPerformed(evt);
            }
        });
        ...
        jLabel15.setText("Tipo do Usuário: ");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "normal", "admin" }));
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(rg)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(EnderecoBairroUser, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addGap(21, 21, 21)
                                        .addComponent(EnderecoRuaUser, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(11, 11, 11)
                                        .addComponent(jLabel10)
                                        .addGap(25, 25, 25)))
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(EnderecoNumUser, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cep, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(22, 22, 22)
                                .addComponent(tel1, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(dataNasc, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(19, 19, 19))
        );
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        String tele1 = tel1.getText();
        String tele2 = tel2.getText();
        String rua = EnderecoRuaUser.getText();
        String num = EnderecoNumUser.getText();
        String bairro = EnderecoBairroUser.getText();
        String cepUser = cep.getText();
        String rgUser = rg.getText();
        String email = Email.getText();
        if (!nome.equals("") && !dataString.equals("") && !tele1.equals("")
                && !rua.equals("") && !num.equals("") && !bairro.equals("") && !cepUser.equals("")
                && !rgUser.equals("") && !email.equals("")) {

            String endereco = String.format("%s, %s, %s, %s", rua, num, bairro, cepUser);
            ...
            String tipoAaaaa = (String) jComboBox1.getSelectedItem();
            System.out.println(tipoAaaaa);
                     
            AgentePublico agentePublico = new AgentePublico(nome, CPF, rgUser, tele1, 
                    tele2, dataNascimento, endereco, email, null, email, 
                    LoginUser.getText(), SenhaUser.getText(), 
                    tipoAaaaa, "ativo");
            
            System.out.println(agentePublico.getTypeUser());
            System.out.println(agentePublico.getStatus());
            
            /*
            AgentePublico(String name, String CPF, String RG, String phoneNumber1, String phoneNumber2,
            ...
            */
            ...
            publicAgentController.inserirAgentePublico(agentePublico);
    ...
    private void EnderecoBairroUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnderecoBairroUserActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_EnderecoBairroUserActionPerformed
