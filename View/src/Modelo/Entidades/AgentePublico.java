...
public class AgentePublico extends Pessoa {
    ...
    public AgentePublico(Integer idPublicAgent, String email, String user, String password,
    ...
    public AgentePublico(String name, String CPF, String RG, String phoneNumber1, String phoneNumber2,
    ...
    public AgentePublico(String name, String CPF, String RG, String phoneNumber1, LocalDate dateOfBirth,
    ...
    public AgentePublico(Integer idPublicAgent, String name, String CPF, String RG, String phoneNumber1,
